        ...
        ?>
                    <tr>
                        <td><a style="text-decoration: none;"
                                href="?action=detail_order&id_of_order=<?php echo $value['id']; ?>">#<?php echo $value['id']; ?></a>
                        </td>
                        ...
                        <td>
                            <button type="button"
                                <?php if (isset($value['status']) && $value['status'] == 'Đã hủy') {echo "disabled";}?>
                                class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#staticBackdrop<?php echo $i; ?>">Hủy</button>
                            <div class="modal fade" id="staticBackdrop<?php echo $i; ?>" data-bs-backdrop="static"
                                data-bs-keyboard="false" tabindex="-1"
                                aria-labelledby="staticBackdropLabel<?php echo $i; ?>" aria-hidden="true">

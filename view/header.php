...
<body>
    ...
    echo '<li><a id="login_header" href="../public/index.php?action=account_info">' . $_SESSION['remember_username_login'] . '</a></li>';
    echo '<li><a id="register_header" href="../public/index.php?action=logout">Đăng xuất</a></li>';
} else {?>

                                <li><a id="login_header" href="../public/index.php?action=login">Đăng nhập</a></li>
                                <!-- bổ sung href  -->
                                <li><a id="register_header" href="../public/index.php?action=register">Đăng ký</a>
                                </li><!-- bổ sung href  -->
                                <?php }?>
                            </ul>
                        </div>
                        <div id="icon_shopping_bag_header" class="icon_header">
                            <a href="?action=cart"><i class="fa fa-shopping-cart"></i></a><!-- bổ sung href  -->
                            <span id="count_book_header"> <?php if (isset($_SESSION['cart'])) {echo count($_SESSION['cart']);} else {
    echo "0";
}
?> </span>
                        </div>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav w-100 justify-content-center">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" aria-current="page" href="../public/index.php?action=home"
                                <?php if (isset($_GET['action']) && $_GET['action'] == 'agree_order') {echo 'style="pointer-events: none;"';}if (isset($_GET['action']) && $_GET['action'] == 'home') {echo 'style="color: white;"';}?>>TRANG
                                CHỦ</a>
                        </li>
...
if (isset($result_of_all_category)) {
    foreach ($result_of_all_category as $value) {
        ?>
                        ...
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="../public/index.php?action=about"
                                <?php if (isset($_GET['action']) && $_GET['action'] == 'agree_order') {echo 'style="pointer-events: none;"';}if (isset($_GET['action']) && $_GET['action'] == 'about') {echo 'style="color: white;"';}?>>GIỚI
                                THIỆU</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="../public/index.php?action=contact"
                                <?php if (isset($_GET['action']) && $_GET['action'] == 'agree_order') {echo 'style="pointer-events: none;"';}if (isset($_GET['action']) && $_GET['action'] == 'contact') {echo 'style="color: white;"';}?>>LIÊN
                                HỆ</a>
                        </li>
                    </ul>
                </div>
